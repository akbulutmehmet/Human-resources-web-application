           ...
           <div class="card-body">
             <form action="${pageContext.request.contextPath}/aday/adaySerftifikaKaydet" method="post" enctype="multipart/form-data">
               <div class="form-gruop mb-1">
                 ...
                 <input class="form-control" type="text" name="adaySerftifikaAd" id="adaySerftifikaAd"  placeholder="Serftika Adını Giriniz" required>
               </div>

               <div class="form-gruop mb-1">
                 <label for="adaySerftifikaUrl">Serftika Doğrulama Adresi</label>
                 <input class="form-control" type="url" name="adaySerftifikaUrl" id="adaySerftifikaUrl"  placeholder="Serftika Doğrulama Adresi" required>
               </div>


               <div class="form-gruop mb-1">
                 <label for="adaySerftifikaTarih">Serftifika Tarihini Giriniz</label>
                 <input class="form-control" type="date" name="adaySerftifikaTarih" id="adaySerftifikaTarih" max=""  required>
               </div>
